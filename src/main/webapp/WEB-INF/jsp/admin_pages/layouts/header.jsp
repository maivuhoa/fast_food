                            ...
                            <ul class="dropdown-menu-list withScroll" data-height="220">
                                <li class="clearfix">
                                        <span class="pull-left p-r-5">
                                            <img src="/public/admin_pages/img/avatars/avatar3.png" alt="avatar 3">
                                        </span>
                                    <div class="clearfix">
                                        <div>
                                ...
                                <li class="clearfix">
                                        <span class="pull-left p-r-5">
                                            <img src="/public/admin_pages/img/avatars/avatar4.png" alt="avatar 4">
                                        </span>
                                    <div class="clearfix">
                                        <div>
                                ...
                                <li class="clearfix">
                                        <span class="pull-left p-r-5">
                                            <img src="/public/admin_pages/img/avatars/avatar5.png" alt="avatar 5">
                                        </span>
                                    <div class="clearfix">
                                        <div>
                                ...
                                <li class="clearfix">
                                        <span class="pull-left p-r-5">
                                            <img src="/public/admin_pages/img/avatars/avatar6.png" alt="avatar 6">
                                        </span>
                                    <div class="clearfix">
                                        <div>
