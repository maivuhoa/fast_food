...
<div id="main-content">
    <div class="page-title">
        ...
        <h3><img class="m-r-20" src="images/invoice.png" alt="invoice"><strong>Order n° 547 578 528</strong>
        ...
        <div class="col-md-12">
            <div class="tabcordion">
                <ul id="myTab" class="nav nav-tabs">
                    ...
                    <li><a href="#order_history" data-toggle="tab">Past Orders
                                ...
                                <form class="form-horizontal p-20">
                                    ...
                                    <div class="form-group m-t-60">
                                        <div class="col-sm-8 col-sm-offset-4">
                                            <a class="btn btn-block btn-primary" href="ecommerce_invoice.html">See Invoice</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="col-md-12">
                                <table id="products-table" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th><strong>Amount before Taxe</strong>
                                        </th>
                                        <th><strong>Taxe Amount</strong>
                                        </th>
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td><a href="ecommerce_product_view.html" data-rel="tooltip" title="Edit Product">Product 1</a></td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td><a href="ecommerce_product_view.html" data-rel="tooltip" title="Edit Product">Product 2</a></td>
                                        <td>HY 658 878 995</td>
                                        ...
                                        <td>$33.80 </td>
                                        <td class="text-center">
                                            <span class="label label-danger w-300">Unavailable (15 days)</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td><a href="ecommerce_product_view.html" data-rel="tooltip" title="Edit Product">Product 3</a></td>
                                        <td>KI 662 554 770</td>
                                        <td>Children / Socks</td>
                                        <td>$5.20</td>
                                        <td>1</td>
                                        <td>$5.20</td>
                                        <td>0.52</td>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6 col-md-offset-6">
                                    <div class="well">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <i class="fa fa-shopping-cart f-80"></i>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <form class="form-horizontal">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <strong>jmiller@outlook.com</strong>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-4">Past Orders:
                                                    </div>
                                            <div class="col-sm-8">
                                                <strong>3</strong>
                                            </div>
