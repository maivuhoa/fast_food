...
<div id="main-content">
    <div class="m-b-20 clearfix">
        <div class="page-title pull-left">
            <h3 class="pull-left"><strong>Manage Combo</strong></h3>
        </div>
        <div class="pull-right">
            <a href="/admin/combo/new" class="btn btn-success m-t-10"><i class="fa fa-plus p-r-10"></i> Add a combo</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                            ...
                            <table class="table table-tools table-hover">
                                ...
                                <tbody>
                                <c:forEach var="combo" items="${listCombo}">
                                    <tr>
                                        ...
                                        <td class="text-center ">
                                            ...
                                            <a href="/admin/products/${combo.getIdProduct()}/delete" onclick="return confirm('Bạn có muốn xóa?')" class="delete btn btn-sm btn-default"><i class="fa fa-times-circle"></i> Remove</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
