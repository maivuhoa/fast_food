                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
                            <table id="products-table" class="table table-tools table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>London</td>
                                    <td class="text-center">
                                        <span class="label label-dark w-300">Payment canceled</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="ecommerce_order_view.html" class="view btn btn-sm btn-default"><i class="fa fa-search"></i> View</a>
                                    </td>
                                ...
                                <tr>
                                    <td>12</td>
                                    <td>28/07/2013</td>
                                    <td>KI 658 556 568</td>
                                    <td>Dylan Mac Namara</td>
                                    <td>$134.00</td>
                                    <td>4</td>
                                    <td>No date</td>
                                    <td>Miami</td>
                                ...
                                <tr>
                                    <td>15</td>
                                    <td>21/07/2013</td>
                                    <td>KI 325 744 668</td>
                                    <td>Bryan Oconnors</td>
                                    <td>$32.05</td>
                                    <td>1</td>
                                    <td>No date</td>
                                    <td>Los Angeles</td>
                                ...
                                <tr>
                                    <td>19</td>
                                    <td>13/07/2013</td>
                                    <td>UY 668 445 545</td>
                                    <td>Morris Phillips</td>
                                    <td>$545.00</td>
                                    <td>23</td>
                                    <td>No date</td>
                                    <td>Los Angeles</td>
                                    <td class="text-center">
                                        <span class="label label-danger w-300">Payment received</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="ecommerce_order_view.html" class="view btn btn-sm btn-default"><i class="fa fa-search"></i> View</a>
                                    </td>
