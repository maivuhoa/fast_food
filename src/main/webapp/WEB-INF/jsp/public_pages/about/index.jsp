<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<section class="about-main clearfix" id="kfc_static_page_load">
    <div class="content gioi-thieu">
        <div class="container wap-sec-tin-tuc">
                                    ...
                                    <div class="list-about-items">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 image">
                                                <div class="clearfix"><img class="center-block img-responsive" src="/public/public_pages/uploads/product/xoi-mit.png" style="width: 489px; height: 361px;" /></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="list-about-items">
                                            <div class="row">
                                                <div class="top-text col-md-12">
                                                    ...
                                                    <div class="col-md-6 image">
                                                        <div class="clearfix"><img class="center-block img-responsive" src="/public/public_pages/uploads/product/khoai-lang-chien.png" style="width: 528px; height: 434px;" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
