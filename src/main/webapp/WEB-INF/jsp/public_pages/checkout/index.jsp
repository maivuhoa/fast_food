...
<section class="sec-thuc-don sec-dktv clearfix" style="">
    <div class="container wap-sec-thuc-don b-fix">
        ...
        <div class="note-b">
            ...
            <strong>Sau 22:00,</strong>
            3CE'S Food sẽ không thể giao hàng tận nơi ở một số khu vực. <a href="javascript:void(0)" onclick="timePayment()">Xem
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div autocomplete="off" class="popup-login wap-dktv">
                                                        <form action="/login" method="post" accept-charset="utf-8" id="frm_login">
