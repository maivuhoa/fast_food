...
Modernizr.load([{
    ...
    yep: 'admin_pages/assets/plugins/retina.js'
}]);
    ...
    $('.send-message').keypress(function (e) {
        if (e.keyCode == 13) {
            var chat_message = '<li class="img">' +
                ...
                '<img src="admin_pages/assets/img/avatars/avatar1.png" data-retina-src="admin_pages/assets/img/avatars/avatar1_2x.png"/>' +
...
var setColor = function (color) {
    ...
    $('#theme-color').attr("href", "admin_pages/assets/css/colors/" + color_ + ".css");
    if ($.cookie) {         
...
if($.cookie('style-color')){
    ...
    $('#theme-color').attr("href", "/admin_pages/assets/css/colors/color-dark.css");
}
...
if ($('.table-dynamic').length && $.fn.dataTable) {
    $('.table-dynamic').each(function () {
        ...
        if ($(this).hasClass('table-tools')) {
            ...
            opt.oTableTools = {
                "sSwfPath": "admin_pages/assets/plugins/datatables/swf/copy_csv_xls_pdf.swf",
