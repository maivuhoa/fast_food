...
public class PublicOrderController extends PublicSuperControler{
    ...
    @PostMapping("/order")
    public String index(@RequestParam("name") String name, @RequestParam("address") String address, @RequestParam("_district") String district, @RequestParam("ward") String ward, @RequestParam("phone") String phone, ModelMap modelMap) {
